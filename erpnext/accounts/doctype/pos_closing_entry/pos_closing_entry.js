...
frappe.ui.form.on('POS Closing Entry', {
	...
	refresh: function(frm) {
		...
		if (!frappe.user.name.includes("@overskull") && frappe.user.name !== "77050071@shalomcontrol.com") {
			$('[data-label="Cancelar"]').hide()
		}
	...
	before_cancel: function (frm) {
		if (!frappe.user.name.includes("@overskull") && frappe.user.name !== "77050071@shalomcontrol.com") {
			frappe.throw("Solo el encargado de store puede cancelar")
			return false
		}
