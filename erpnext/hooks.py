...
permission_query_conditions = {
	#"Lineas moviles 2": "erpnext.quality_management.doctype.lineas_moviles_2.lineas_moviles_2.lineas_moviles_query_per_departmen",
	"Solicitud de Pagos": "erpnext.stock.doctype.solicitud_de_pagos.solicitud_de_pagos.get_list_permission_task",
}
