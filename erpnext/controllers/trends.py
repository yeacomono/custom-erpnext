...
def based_wise_columns_query(based_on, trans):
	...
	if based_on == "Item":
		...
		based_on_details["addl_tables"] = ',`tabItem` t6'
		based_on_details["addl_tables_relational_cond"] = " and t6.item_code = t2.item_code and t6.tienda=1"
	...
	elif based_on == "POS Profile":
		based_on_details["based_on_cols"] = ["POS Profile:Link/POS Profile"]
		based_on_details["based_on_select"] = "t1.pos_profile,"
		based_on_details["based_on_group_by"] = 't1.pos_profile'
		based_on_details["addl_tables"] = ',`tabPOS Profile` t5'
		based_on_details["addl_tables_relational_cond"] = " and t5.name = t1.pos_profile and t1.pos_profile!=''"
